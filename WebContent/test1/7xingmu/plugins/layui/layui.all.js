	...
	A.prototype.config = {
		...
		if(n.url) {
			...
			c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
				...
				dataType: "json",
				success: function(t) {
					return t[r.statusName] != r.statusCode ? (a.renderForm(), a.laymain.jsp('<div class="layui-none">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), i && l.close(i), void("function" == typeof n.done && n.done(t, e, t[r.countName])))
				},
				error: function(e, t) {
					a.laymain.jsp('<div class="layui-none">数据接口请求异常</div>'), a.renderForm(), i && l.close(i)
				}
			})
		...
		return c.key = s.id || s.index, d.cache[c.key] = u, r ? p() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.laymain.jsp('<div class="layui-none">无数据</div>')) : (p(), void(s.page && (c.page = n, c.count = o, a.render({
		...
		u.sortKey = {
			field: r,
			sort: i
		}, "asc" === i ? c = layui.sort(y, r) : "desc" === i ? c = layui.sort(y, r, !0) : (c = layui.sort(y, d.config.indexName), delete u.sortKey), u.renderData({
			data: c
