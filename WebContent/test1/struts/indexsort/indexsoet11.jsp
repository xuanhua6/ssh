...
function productsearch(curr,limit) { 
		layui.use(['form','table','laypage'], function() {
			...
			table.render({
    			...
    			,width:900
    			,cellMinWidth:20
    			,cols: [[{field:'feenback',title: '编号',rowspan: 12}
    				],[
		     			{field:'feenback_id' ,width:108, title: '编号', rowspan: 2}
		     			,{field:'feenback_name' , title: '指标类别', edit: 'text', rowspan: 2}
		     			,{field:'分值' , title: '分值',width:60, edit: 'text', rowspan: 2}
		     			,{field:'老师' , title: '老师', edit: 'text'}
					 ], [
